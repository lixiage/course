    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i>添加方向</h3>

            <!-- BASIC FORM ELELEMNTS -->
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <form class="form-horizontal style-form" action="{{ url('addDirectionDo') }}" method="post">
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">请输入方向名称</label>
                                <div class="col-sm-10">
                                    <input type="text" name="dir_name"  class="form-control"/>
                                </div>
                            </div>

                            <button type="submit" class="btn btn-theme">添加方向</button>
                        </form>
                    </div>
                </div><!-- col-lg-12-->
            </div><!-- /row -->
