    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i>添加章节</h3>

            <!-- BASIC FORM ELELEMNTS -->
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <form class="form-horizontal style-form" action="{{ url('addChapterDo') }}" method="post">
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">请输入章节名称</label>
                                <div class="col-sm-10">
                                    <input type="text" name="chap_name"  class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-theme">添加章节</button>
                        </form>
                    </div>
                </div><!-- col-lg-12-->
            </div><!-- /row -->
