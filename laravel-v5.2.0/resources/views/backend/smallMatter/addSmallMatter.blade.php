    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i>添加小节</h3>

            <!-- BASIC FORM ELELEMNTS -->
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <form class="form-horizontal style-form" action="{{ url('addSmallMatterDo') }}" method="post">
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">请选择课程名称</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">请选择章节名称</label>
                                <div class="col-sm-10">
                                    <select name="chap_id" class="form-control">
                                        @foreach($smallMatterData as $v)
                                            <option value="{{ $v->chap_id }}">{{ $v->chap_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">请输入小节名称</label>
                                <div class="col-sm-10">
                                    <input type="text" name="small_name"  class="form-control"/>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-theme">添加小节</button>
                        </form>
                    </div>
                </div><!-- col-lg-12-->
            </div><!-- /row -->
