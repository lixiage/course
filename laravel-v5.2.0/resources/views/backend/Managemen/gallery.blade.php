...
<section id="container" >
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> 用户展示列表 </h3>

            <div class="row mt">
                <div class="col-md-12">
                    <div class="content-panel">
                        <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i> 用户列表&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="usePower">管理员添加</a></h4>
                            <hr>
                            <thead>
                            <tr>
                                <th><i class="fa fa-bullhorn"></i><span style="width:30px;margin-left:30px;">管理员名称</span></th>
                            ...
                            <tr>
                                <th><span style="margin-left:50px;"><?php echo $val->uname?></span></th>
                                <th><a href="usePower?id=<?php echo $val->uid?>">为用户赋权</a> | <a href="">移除</a></th>
                            </tr>
                            <?php }?>
                            </tbody>
                        </table>
