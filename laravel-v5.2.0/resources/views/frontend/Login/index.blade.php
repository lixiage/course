...
<link rel="stylesheet" href="{{asset('frontend/css/index/style.css')}}" type="text/css">
...
<script src="{{asset('layer-v3.1.0/layer/layer.js')}}"></script>
<script>
    $(function(){
...
<div class="g-banner pr">
    ...
    <div class="menuContent">
        ...
        <div class="item" data-id="a">
            <a href="{{url('Freeindex',['id'=>$v->dir_id])}}" target="_blank">
				<span class="group">{{ $v->dir_name }}</span>
    ...
    <div class="g-banner-content">
        ...
        <div class="path-banner clearfix">
            ...
            @foreach($zhi as $k=>$v)
            <a href="{{url('Elastic',['id'=>$v->z_id])}}" target="_blank" data-track="ljtj-1-1">
                <i class="i-web"></i>
                <p class="tit">{{$v->z_name}}</p>
    ...
    <div class="bgfff">
        <div class="container-types clearfix">
            <h3 class="types-title">
                <span class="tit-icon icon-shizhan-l tit-icon-l"></span><em>实</em>／<em>战</em>／<em>推</em>／<em>荐</em><span class="tit-icon icon-shizhan-r tit-icon-r"></span>								<!-- <a href='http://coding.imooc.com' class='types-title-more' target="_blank">					<span>更多</span>					<i class='imv2-arrow2_r'></i>				</a> -->							</h3>
			...
			<a target="_blank" class="course-card" href="{{url('owhd_shop',['cour_id'=>$v->cour_id])}}">
										...
										<img class="course-banner" src="{{$v->cour_image}}">
										
					
										<div class="course-label">
																		<label>{{$v->cour_name}}</label>
																	</div>
									</div>
				<div class="course-card-content">
					<h3 class="course-card-name">{{$v->cour_content}}</h3>
...
<!--script-->
<script type="text/javascript" src="{{asset('frontend/js/index/error.js')}}"></script>
<script src="{{asset('frontend/js/index/ssologin.js')}}"></script>
<script type="text/javascript" src="{{asset('frontend/js/index/sea.js')}}"></script>
<script type="text/javascript" src="{{asset('frontend/js/index/sea_config.js')}}"></script>
